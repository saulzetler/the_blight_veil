# Scene 05 — Roleplay: "Maria Zurita's House"
...
| | |
|---|---|
| **Scene type** | Roleplay / Confrontation — no combat |
| **Estimated time** | 40–60 minutes |
| **Location** | The Ashroot outskirts — direction determined by Scene 02's chosen exit route |
| **Movable?** | No. Follows Scene 04 directly. |
| **Entry condition** | Morning. The party arrives at the source of the lead they chose in Scene 03. |
| **Exit condition** | Maria is met, and the Fergie choice point has shaped the scene. Flows directly into Scene 06 — do not treat this as a hard stopping point. |
...
> [!important] Must Hit
> **① The house and approach are described with the same "beauty buried in decay" tone as the rest of the campaign** — isolated, not derelict. This is a home, not a lair.

> [!important] Must Hit
> **② Maria is seen and named for the first time.** This is her first full in-person appearance in the campaign — well ahead of where the loose Act 1 roadmap originally placed it, run this way because the table wants it as this session's centerpiece.
...
> - Let the other PCs have real reactions to Maria independent of Fergie — Zennor's wariness, Hog's bluntness, Oscar's curiosity (and, quietly, recognition — see the DM note on Oscar below).
> - A sharp **Insight check (DC 15)** reveals Maria is scared she isn't real, underneath the composure.
> - If a player asks how she reacts to hearing about Thane's airship, let her visibly, briefly, drop her guard — see Running Notes.
...
> [!warning] DM Only
> - **This is deliberately not a fixed script.** Draw the shape from `fergie_arc.md`'s Act II material and `maria_zurita.md`'s established voice, but let Fergie's player's choices actually steer the scene. Whatever they play, Maria responds in kind.
> - **She is Concord Vision branch** — quietly separate from the Might-branch chaos the party just fled. If a player mentions Thane's airship, let her reaction read as unease rather than solidarity; the Trifarix is not a unified front, and she knows it better than most.
> - **Do not resolve the Echo/timeline lore fully here.** This is a first meeting, not `fergie_arc.md`'s Act IV endgame confrontation. Plant, don't harvest.
> - **Oscar should feel something too, quietly, ahead of Scene 06's reveal.** Nothing overt — maybe the terrarium reacts faintly to her Porter Stone's harmonic signature, the way it reacted to the crystalline housing last session. A breadcrumb for Scene 06, not a spoiler.
> - Full stat blocks and mechanical detail for Maria live in `03_characters/npcs/maria_zurita.md` — this scene is not built to require combat, but if things go sideways at your table, her Acolyte-level block (CR 3) is the one to reach for, not the Echo-Awakened Seer (CR 7).

---

## NPC: Maria Zurita — This Scene's Version

*(Full reference: `03_characters/npcs/maria_zurita.md` and `03_characters/players/fergie/fergie_arc.md`.)*

| | |
|---|---|
| **Race / Age** | Fire Genasi, Blue-Flame Variant · 18 |
| **Allegiance** | Concord — Vision Branch, Seer-Acolyte |
| **Appearance** | Moves like someone who has studied every step before taking it. Blue flame hair, ember-lit freckles pulsing with harmonic resonance. Concord Vision robes — layered geometric fabric, bronze filigree. A pale opal Porter Stone in her palm, humming in perfect inversion to Fergie's. |
| **Voice / tone** | Controlled, quiet, almost meditative. Occasionally finishes Fergie's sentences or anticipates his phrasing. When emotional, her voice harmonizes — two tones layered unnaturally. |
| **Demeanour with Fergie** | Mirrors his posture subconsciously. Watches him with equal parts scientific and emotional curiosity. Pauses before speaking, as if listening to another self inside her head. |
| **Demeanour with everyone else** | Polite, reserved, slightly alien, overly formal — Concord training. Rare, startling moments of vulnerability break through. |
| **What she wants** | To understand whether she's real. To figure out whether Fergie is the danger, or she is. |
| **What she's hiding** | Her Hidden Orders: *"If the Echo cannot be stabilized, it must be severed."* Surfaces in Scene 06, not here. |

---

## Approaching, By Route Chosen in Scene 02

Use whichever exit the party took out of Rootspire to color the approach.
...
> [!quote] Read Aloud
> You come down out of the high paths and see the house below you first, before you're anywhere near it — a single structure at the edge of a clearing, smoke rising from its chimney in a thin, steady line. The smoke doesn't move like smoke should. It curls the wrong way, cold instead of warm, like something reversed.
...
*(From `fergie_arc.md` Act II — "How Fergie Treats Maria." This is the scene's real engine. Watch Fergie's player and let Maria respond in kind.)*

| If Fergie plays it with… | Maria… | Sample Line |
|---|---|---|
| **Kinship** | Softens. A bond starts forming, and she may begin doubting the Concord in front of the party. | *"I didn't think — I didn't let myself think anyone would look at me like that. Like I was the one who mattered, and not just the question I answer."* |
| **Suspicion** | Grows adversarial — controlled, but visibly hurt underneath it. | *"You think I'm the danger. Perhaps. I've thought the same about you since I first felt your Stone. That doesn't mean either of us is wrong to be afraid."* |
| **Denial** | Goes cold, convinced *he's* the unstable one, not her. | *"You can refuse to see it. That won't make it stop being true. I am not the one who's confused about what's real, Fergie."* |
...
| Check | DC | Result |
|---|---|---|
| Insight (Maria's fear) | 15 | Underneath the composure, she's scared she isn't real. |
...
## If / Then — Other Party Members

| If... | Then... |
|---|---|
| Zennor is wary or hostile | Maria doesn't retaliate — she reads it, notes it, and becomes more careful with her words around him specifically. |
| Hog is blunt or tries to lighten the mood | She's visibly thrown by this — not offended, just unfamiliar with being spoken to so plainly. A rare small, real smile is possible here if you want to humanize her early. |
| Oscar approaches with curiosity | Let her regard him a beat too long before answering anything he asks — she recognizes something about him she isn't ready to name yet. Save the explicit version for Scene 06. |
| The party threatens her outright | She doesn't panic — Concord Seer training holds. But her Stone flickers with inverted color, and it's the first crack in her composure the party sees, regardless of how Fergie played his choice point. |
