...
| | |
|---|---|
| **Scene type** | Roleplay / Dramatic reveal, light rolls |
...
> [!important] Must Hit
> **① The sky changes.** A Concord airship — the first anyone in Rootspire has ever seen — eclipses the canopy light above the city.

> [!important] Must Hit
> **② High Marshal Varric Thane appears in person** and publicly declares Rootspire is harboring known terrorists, naming Captain Deyran's death and the party's defiance of the Council trial as proof.

> [!important] Must Hit
> **③ Two warning shots land. No one dies.** Every player gets exactly one narrated action and one roll — no grid, no positions, no damage math unless someone does something reckless enough to earn it.
...
> - **Kett** tugs at a party member's sleeve during the chaos and finally confesses what she saw days ago — a Concord agent in plain clothes near the city's edge. (Can also be saved for Scene 03 if it doesn't fit here.)
> - A sharp **Perception check (DC 15)** during the second shot gets a clean look at Thane himself — ceremonial steel, the Banner of the First Flame catching the light.
> - **Boughwarden Thalan**, if nearby, goes visibly pale and still — his years of trying to keep this exact ship out of Rootspire's sky have just failed in real time.
> - **Old Wren** mutters something about having seen a sky like this before, decades ago, and not finishing the thought.
...
> [!warning] DM Only
> - **This is a deliberate escalation, not routine.** Thane is a Trifarix Pillar who runs the Legion of the Standard from Orrenval — not a field officer. Play him like someone who does not do this often and is doing it now because it matters. No casual menace. Absolute menace.
> - **Nobody dies today.** The warning shots are exactly that — meant to be felt by the whole city, not to kill the party. Keep any "damage" narratively minor (a scorch, a stumble, smoke in the lungs) unless a player does something that specifically earns worse.
> - **Keep this to one no-grid mechanic pass, twice.** Don't let it turn into tactical combat. If a player starts asking about squares or ranges, redirect: "there's no map here — what do you do, and what are you rolling?"
...
## NPC: High Marshal Varric Thane, The Pillar of Might

|                            |                                                                                                                                                                                                                                                         |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Full name / Title**      | Varric Thane — Warden of the Concordant Armies, High Marshal, the Pillar of Might                                                                                                                                                                       |
...
## The Warning Shots — Lightweight No-Grid Mechanic

This is a **narration-and-roll** beat, not a combat encounter. Run it exactly like this:

1. **Roll initiative once**, purely to set a speaking order for the table.
...
| Action                                                    | Suggested Check             | DC  |
| --------------------------------------------------------- | --------------------------- | --- |
| Shield a bystander from debris/flame                      | Athletics or Dex save       | 13  |
| Get a clean, useful read on the ship or Thane's intent    | Perception or Investigation | 12  |
| Calm a panicking knot of the crowd for a few seconds      | Persuasion                  | 14  |
| Get a clear, detailed look at Thane himself               | Perception                  | 15  |
| Identify the fire as mundane war-craft, not sorcery       | Arcana                      | 12  |
| Read whether Thane means to actually level the city today | Insight                     | 14  |

**On a success:** the action works cleanly, and give a small vivid detail as reward (the bystander is safe and grateful, the crowd genuinely settles for a moment, Thane's expression is unreadable but his grip on the rail isn't). **On a failure:** nothing catastrophic — the moment just doesn't land the way the PC hoped (the bystander still gets knocked down but isn't hurt, the crowd surges past anyway, the detail stays hazy). Keep every outcome survivable and keep the pace brisk.

---

## Sample Dialogue — Thane

Reference lines. He does not banter. If a PC shouts up at him, he may answer once, flatly, and then ignore further provocation.

**If challenged directly:**
> *"You had a trial. You did not like its answer. That does not make it void."*

**If someone claims innocence:**
> *"Then step forward and prove it to me instead of to a Council that has already failed once."*

**On the warning shots themselves:**
> *"This is not the attack. This is the knock on the door."*

**As the ship begins to withdraw (end of scene):**
> *"You have until I return to make the correct choice for your city. I am not, historically, a patient man."*
...
| If the party... | Then... |
|---|---|
| Try to fight back or shoot at the ship | It's far out of any reasonable range and heavily warded — this reads immediately as futile, not brave. A local nearby might even grab their arm: *"Don't. That's exactly what he wants."* |
| Shout up at Thane / try to negotiate | He answers once, flatly (see Sample Dialogue), then the ship's attention moves on. He is not interested in a dialogue today. |
...
> *"The ship doesn't fire again. It doesn't need to. Rootspire is already moving — doors slamming, voices rising, someone screaming for the Boughwarden. And more than a few of those voices, as the smoke clears, are looking directly at you."*

Move directly into **Scene 02 — Backlash and the Way Out.** No pause needed; let the fear from this scene carry straight through.

---

## Threads This Scene Opens

- **The Concord's presence** — Moves from a rumored, distant "three days out" letter to a Trifarix Pillar personally over the city. This is now the campaign's top-line threat.
- **Thane, in person** — His first live appearance. Whatever impression the party forms here (an unstoppable force, a man performing dominance, a bureaucrat with real menace behind the theatre) will color every future encounter with Might branch.
- **Kett's secret** — If surfaced here, confirms Rootspire wasn't safe from Concord eyes even before today.

---
*The Blight Veil | Session 6 | Scene 01 of 06*
